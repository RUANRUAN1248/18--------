...
#define TFT_SPIN 		SPI_CH1			//定义使用的SPI号
#define	TFT_SCL_PIN 	SPI_CH1_SCLK_P15	//定义SPI_SCK引脚
#define	TFT_SDA_PIN		SPI_CH1_MOSI_P13   //定义SPI_MOSI引脚
#define	TFT_SDA_IN_PIN	SPI_CH1_MISO_P14   //定义SPI_MISO引脚  TFT屏幕没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
